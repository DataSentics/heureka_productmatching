...
# for more info, visit https://research.variancia.com/czech_stemmer/

# released under Creative Commons Attribution 3.0 Unported License, 
# see https://creativecommons.org/licenses/by/3.0/

# when using previously in DS by Shadi, it turned out to be too aggressive in some cases, 
...
def cz_stem(word, aggressive=False):
    if not re.match("^\\w+$", word):
        return word
    # edited: do not skip if mixed case
